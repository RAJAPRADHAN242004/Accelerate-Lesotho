import "../css/BusinessHero1.css";
import booking from "../assets/booking.jpg"; 
import { Link } from "react-router-dom";

function BusinessHero1() {
  return (
    <div
    ...
    >
      <div className="business-hero-overlay">
        <div className="business-hero-content">
          <h3 className="business-hero-title">Trade Missions</h3>
          <h1 className="business-hero-heading">Multi-sector Trade Missions</h1>
          ...
          <h1 className="business-hero-heading">Fact-finding Mission</h1>
          <p className="business-hero-subtitle">
           ...
           <div className="business-hero-button-wrapper">
            <Link to="/service" className="business-hero-button">Our Services</Link>
          </div>
        </div>
